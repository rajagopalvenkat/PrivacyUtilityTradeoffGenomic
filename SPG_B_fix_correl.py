...
f=open("flipcounts/mix_def_results/fix/correl_mdf_theta_"+str(theta)+'_w_'+str(mask_wt)+"_"+str(sys.argv[3]), 'w')
...
dvf = open("dvar_mixcorrel_fix_"+str(theta)+"_"+str(mask_wt)+"_"+str(sys.argv[3]), 'w')
